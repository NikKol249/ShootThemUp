...
bool ASTUBaseWeapon::GetPlayerViewPoint(FVector& ViewLocation,
...
bool ASTUBaseWeapon::GetTraceData(FVector& TraceStart,
...
bool ASTUBaseWeapon::TryToAddAmmo(int32 ClipsAmount)
{
	...
	else if(CurrentAmmo.Clips < DefaultAmmo.Clips)
	{
		...
		if(DefaultAmmo.Clips - NextClipsAmount >= 0)
		{
			...
			UE_LOG(BaseWeaponLog, Display, TEXT("Clips ware added"));
		}
		else
		{
